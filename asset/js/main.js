    ...
    document.addEventListener("click", (event) =>{
        if(event.target.classList.contains('link-item')){
            ...
            if(event.target.hash !==""){
                ...
                // deactivate existing active 'active'
                ...
                hideNavMenu();
                    ...
                    navItems.forEach((item) =>{
                        if(hash === item.hash){
                            //activate the new navigation memu 'link-item'
...
(() =>{
    ...
    function popupDetails(){
        if(!portfolioItems[itemIndex].querySelector(".porfolio-item-details")){
            projectDetailsBtn.style.display="non";
            return;   
        }
        ...
        .querySelector(".porfolio-item-details").innerHTML;
